...
int root(int launchID) {
    ...
    rsMatrixLoadPerspective(&proj, 60.0f, aspect, 0.1f, 100.0f);
    ...
    rsgFontColor(1.0f, 0.0f, 1.0f, 1.0f);
    ...
    rsgDrawQuad(startX, startY, startZ, 
                         startX, startY + 100, startZ, 
                         startX + 100, startY + 100, startZ, 
                         startX + 100, startY, startZ);
