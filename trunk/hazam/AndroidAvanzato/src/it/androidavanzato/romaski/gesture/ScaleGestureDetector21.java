package it.androidavanzato.romaski.gesture;
 ...
 * </ul>
 */
class ScaleGestureDetector21 extends ScaleGestureDetector {
    /**
    ...
    public interface OnScaleGestureListener {
         ...
         *          greater than 0.01.
         */
        public boolean onScale(ScaleGestureDetector21 detector);
         ...
         *          rest of the gesture.
         */
        public boolean onScaleBegin(ScaleGestureDetector21 detector);

        /**
         * Responds to the end of a scale gesture. Reported by existing
         * pointers going up.
         *
         * Once a scale has ended, {@link ScaleGestureDetector21#getFocusX()}
         * and {@link ScaleGestureDetector21#getFocusY()} will return the location
         * of the pointer remaining on the screen.
         *
         * @param detector The detector reporting the event - use this to
         *          retrieve extended info about event state.
         */
        public void onScaleEnd(ScaleGestureDetector21 detector);
    }
     ...
     * {@link OnScaleGestureListener#onScale(ScaleGestureDetector21)} returns
     * {@code false} so that a subclass can retrieve the accumulated scale
     * factor in an overridden onScaleEnd.
     * {@link OnScaleGestureListener#onScaleBegin(ScaleGestureDetector21)} returns
     * {@code true}.
     */
    ...
    public ScaleGestureDetector21(Context context, ScaleGestureDetector del) {
		mDelegate = del;
        ...
        if (!mGestureInProgress) {
            ...
            case MotionEvent.ACTION_POINTER_DOWN: {
                ...
                if (p0sloppy && p1sloppy) {
                    ...
                    mGestureInProgress = mDelegate.notifyScaleBegin();
                }
            }
            break;
            ...
            switch (action & MotionEvent.ACTION_MASK) {
                ...
                case MotionEvent.ACTION_MOVE:
                    ...
                    if (mCurrPressure / mPrevPressure > PRESSURE_THRESHOLD) {
                        final boolean updatePrevious = mDelegate.notifyScale();
